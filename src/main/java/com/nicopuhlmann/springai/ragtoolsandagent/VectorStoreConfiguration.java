...
public class VectorStoreConfiguration {
    ...
    @Value("classpath:/data/attention.pdf")
    private Resource attention;
    ...
    SimpleVectorStore simpleVectorStore(EmbeddingModel embeddingModel) throws IOException {
        ...
        if (vectorStoreFile.exists()) {
            ...
            PagePdfDocumentReader pdfReader = new PagePdfDocumentReader(attention);
            List<Document> documents = pdfReader.read();
            log.info("Dokument {} geladen, {} Seiten.", attention.getFilename(), documents.size());
